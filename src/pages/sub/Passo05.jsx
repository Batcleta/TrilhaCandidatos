...
const MotivoDaCandidat = (props) => {
  ...
  const onSubmit = async (data) => {
    ...
    await sessionStorage.setItem("motivoDaCandidat", JSON.stringify(formData));
    ...
    <Fragment>
      ...
      <form className="cadastro" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="form-group">
          <input
            type="text"
            placeholder="Digite aqui quanto espera receber"
        ...
        <div className="form-group">
          <label>
            Informe em poucas palavras, por que deseja trabalhar conosco
          </label>
          <textarea
