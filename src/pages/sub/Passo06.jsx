...
const ContadoCandidato = (props) => {
  ...
  const onSubmit = async (data) => {
    ...
    await sessionStorage.setItem("contato", JSON.stringify(formData));
    ...
    <Fragment>
      ...
      <form className="cadastro" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="form-group">
          ...
          <input
            type="tel"
            placeholder="Digite aqui um número celular"
            name="candCelular"
        ...
        {watchTelFixo ? (
          ...
          <div className="form-group">
            <input
              type="tel"
              placeholder="Digite aqui seu número de telefone fixo"
              name="telefoneFixo"
              ref={register({ required: true })}
            />
        ...
        {watchLinkedin ? (
          ...
          <div className="form-group">
            <input
              type="text"
              placeholder="Digite aqui seu endereço Linkedin"
              name="candLinkedin"
              ref={register({ required: true })}
            />
          </div>
        ...
        {watchFacebook ? (
          ...
          <div className="form-group">
            <input
              type="text"
              placeholder="Digite aqui seu endereço do Facebook"
              name="candFacebook"
              ref={register({ required: true })}
            />
          </div>
        ...
        {watchInstagram ? (
          ...
          <div className="form-group">
            <input
              type="text"
              placeholder="Digite aqui seu endereço do Instagram"
              name="candInstagram"
              ref={register({ required: true })}
            />
          </div>
        ...
        {watchTwitter ? (
          ...
          <div className="form-group">
            <input
              type="text"
              placeholder="Digite aqui seu endereço do Twitter"
              name="candTwitter"
              ref={register({ required: true })}
            />
          </div>
